              ...
              <div class="row g-0">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <a href="${d.characters[5]}" target="_blank" class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Click to view character 1 in the book.</a>
                    <a href="${d.characters[10]}" target="_blank" class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Click to view character 2 in the book.</a>
                    <a href="${d.characters[6]}" target="_blank" class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Click to view character 3 in the book.</a>
                    <a href="${d.characters[8]}" target="_blank" class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Click to view character 4 in the book.</a>
                    <a href="${d.characters[12]}" target="_blank" class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Click to view character 5 in the book.</a>
                    <br>
                    <div class="buy-btn">
